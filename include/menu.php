                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">SMK  MedikaCom</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Kampus 1 : Jl Rancabolang NO.B.10 Soekarno-Hatta Rancabolang Bandung Telp(022)7567703</p>';
                            }
                        }
                    ?>
                </div>
